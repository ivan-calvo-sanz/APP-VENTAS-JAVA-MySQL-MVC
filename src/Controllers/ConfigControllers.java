...
public class ConfigControllers implements MouseListener {
    ...
    public void mouseExited(MouseEvent e) {
        if (e.getSource() == frmAdmin.jLabel_NuevaVenta) {
            ...
            frmAdmin.jPanel_NuevaCompra.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Productos) {
            frmAdmin.jPanel_Productos.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Clientes) {
            frmAdmin.jPanel_Clientes.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Proveedor) {
            frmAdmin.jPanel_Proveedor.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Medidas) {
            frmAdmin.jPanel_Medidas.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Categorias) {
            frmAdmin.jPanel_Categorias.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Configuracion) {
            frmAdmin.jPanel_Configuracion.setBackground(new Color(51, 51, 51));
        }else if (e.getSource() == frmAdmin.jLabel_Usuaio) {
            frmAdmin.jPanel_Usuarios.setBackground(new Color(51, 51, 51));
        }
    }
